$private = Get-ChildItem -Path "D:\Code\JsonMenu\JsonMenu\Private" -Include *.ps1 -File -Recurse -ErrorAction Stop
$public = Get-ChildItem -Path "D:\Code\JsonMenu\JsonMenu\Private" -Include *.ps1 -File -Recurse -ErrorAction Stop
...
Get-Member -Name JsonMenu.Action.CallMethod
